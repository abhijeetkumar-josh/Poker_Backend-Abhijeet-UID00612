...
class ticket(models.Model):   
    ...
    finalEstimate=models.IntegerField(blank=True, null=True, validators=[MinValueValidator(1), MaxValueValidator(100)])
...
class estimate(models.Model):   
    ...
    estimate = models.IntegerField(blank=True,null=True,validators=[MinValueValidator(1),MaxValueValidator(100)])
    estimate_date = models.DateField(blank=True, null=True)

    def __str__(self):
        return f"{self.ticket.summary} - {self.user.username}"
